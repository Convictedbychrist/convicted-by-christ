# Convicted by Christ · New Discipleship Bible Study

Everything the app needs is in one file, `index.html`: all 24 lessons, the Convicted by Christ logo, and the code.

## Put it on GitHub Pages

1. Sign in at github.com and click **New repository**. Name it something like `convicted-by-christ`, set it to **Public**, and click **Create repository**.
...
4. After a minute or two, the page shows your link, like `https://yourname.github.io/convicted-by-christ/`. That's the link to share.
